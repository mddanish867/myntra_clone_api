    ...
    public partial class addedpromotionstable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PromoionId = table.Column<int>(type: "int", nullable: false)
                    ...
                    PromotionMainCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PromotionCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PromotionSubCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PromotionDiscount = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PromotionBrands = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Promotions", x => x.PromoionId);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 29, "", "", "50", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/babe0d1a-b7fe-4b36-8a98-b275523963721690787339222-Shop-By-Category_HP-4_14.jpg", "Kids", "", "SHOP BY CATEGORY" },
                    { 30, "", "Footwear", "50", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/3c2095db-905a-4346-9712-2fac7bcbbbd71690787339011-Shop-By-Category_HP-4_15.jpg", "Men", "", "SHOP BY CATEGORY" },
                    { 31, "", "Footwear", "40", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/c1c8027f-1a22-4a0b-8be2-848edab298cf1690787339044-Shop-By-Category_HP-4_16.jpg", "Women", "", "SHOP BY CATEGORY" },
                    { 32, "", "", "40", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/278917b5-1658-4c2c-b122-f623b1d909701690787339290-Shop-By-Category_HP-4_17.jpg", "Men", "Wallets,Belts", "SHOP BY CATEGORY" },
                    { 33, "", "Topwear", "40", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/6c53770e-b7b2-466a-b36e-a0b2bff1a7591690787339109-Shop-By-Category_HP-4_18.jpg", "Men", "Formal Shirts", "SHOP BY CATEGORY" },
                    { 34, "", "Indian & Festive Wear", "60", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/54852b61-90d6-484a-84c9-a8560247ffc21690787339307-Shop-By-Category_HP-4_19.jpg", "Men", "", "SHOP BY CATEGORY" },
                    { 35, "", "Home Décor", "40", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/5d78afb6-38bb-43bd-bc67-1e4f6026b6ae1690787339327-Shop-By-Category_HP-4_20.jpg", "Home & Living", "", "SHOP BY CATEGORY" },
                    { 36, "", "Handbags, Bags & Wallets", "40", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/90dcb992-9fb4-4208-8249-aa1a01b2851d1690787339476-Shop-By-Category_HP-4_21.jpg", "Women", "", "SHOP BY CATEGORY" },
                    { 37, "", "Gadgets", "70", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/e4fcb9f0-f79a-41b7-b7b2-8828bb6e95e61690787339426-Shop-By-Category_HP-4_22.jpg", "Men", "", "SHOP BY CATEGORY" },
                    { 38, "", "Jewellery", "80", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/66882f76-0bbe-4741-8890-0426695e09131690787339238-Shop-By-Category_HP-4_23.jpg", "Women", "", "SHOP BY CATEGORY" },
                    { 39, "", "Plus Size", "60", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/6aa501b3-ce05-48f5-96fe-ecb64682dbc71690787339409-Shop-By-Category_HP-4_24.jpg", "Women", "", "SHOP BY CATEGORY" },
                    { 40, "", "Plus Size", "60", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/b6e15609-4f52-44db-80c1-2a955fd4ac6e1690787339341-Shop-By-Category_HP-4_25.jpg", "Men", "", "SHOP BY CATEGORY" },
                    { 41, "", "Smart Wearables", "80", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/7916724b-be74-4920-b58d-ada0617cdee91690787339392-Shop-By-Category_HP-4_26.jpg", "Men", "", "SHOP BY CATEGORY" },
                    { 42, "", "Sleepwear & Loungewear", "30", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/5c541739-5c23-4846-a875-f19a170cea151690787339460-Shop-By-Category_HP-4_27.jpg", "Women", "", "SHOP BY CATEGORY" },
                    { 43, "", "Western Wear", "40", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/76932333-b792-4f54-983c-45aaf70e04ef1690787338936-Shop-By-Category_HP-4_28.jpg", "Women", "Blazers & Waistcoats", "SHOP BY CATEGORY" },
                    { 44, "", "Sunglasses & Frames", "80", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/a351ad62-c1d1-4bb4-9967-d3966f8446521690787338974-Shop-By-Category_HP-4_29.jpg", "Men", "", "SHOP BY CATEGORY" },
                    { 45, "", "Topwear", "40", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/130ceab4-ac68-42c5-a9f4-478ba7f903db1690787339061-Shop-By-Category_HP-4_30.jpg", "Men", "Formal Shirts", "SHOP BY CATEGORY" },
                    { 46, "", "Western Wear", "40", "https://assets.myntassets.com/f_webp,w_163,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/cda4c195-22c1-4e11-a9dc-4728d69c3f2b1690787338956-Shop-By-Category_HP-4_31.jpg", "Women", "Dresses", "SHOP BY CATEGORY" },
                    { 47, "", "", "", "https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/46090f9c-e337-4a58-9d67-16bf4b977c6f1690787339358-Shop-By-Category_HP-4_32.jpg", "", "", "SHOP BY CATEGORY" },
                    { 48, "", "Bags & Backpacks", "30", "https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/89e0a0ee-225d-4880-a761-6aa895d252871690787338993-Shop-By-Category_HP-4_33.jpg", "Men", "", "SHOP BY CATEGORY" },
                    { 49, "", "Bags & Backpacks", "30", "https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/82cdf918-9ad9-41fa-a5a7-c4c86fbad90c1690787338876-Shop-By-Category_HP-4_34.jpg", "", "", "SHOP BY CATEGORY" },
                    { 50, "", "Footwear", "30", "https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/ed2e98bc-e4f4-4e85-bc74-537142205d0f1690787339374-Shop-By-Category_HP-4_35.jpg", "Men", "Flip Flops", "SHOP BY CATEGORY" },
                    { 51, "", "", "", "https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/c61b51c7-67cb-4d02-9f50-3492d08c0bba1690787339256-Shop-By-Category_HP-4_36.jpg", "", "", "SHOP BY CATEGORY" },
                    { 52, "", "", "", "https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/31/c61b51c7-67cb-4d02-9f50-3492d08c0bba1690787339256-Shop-By-Category_HP-4_36.jpg", "", "", "SHOP BY CATEGORY" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ProductSpecifications",
                columns: new[] { "SpecificationId", "ProductId", "ProductsProductId", "SpecificationKey", "SpecificationValue" },
                values: new object[,]
                {
                    { 1, 1, null, "Fabrick", "Cotton" },
                    { 2, 1, null, "Fit", "Regular Fit" },
                    { 3, 1, null, "Length", "Regular" },
                    { 4, 1, null, "Main Trend", "New Basic" },
                    { 5, 1, null, "MultiPack Set", "2" },
                    { 6, 1, null, "Collar", "Polo Collar" },
                    { 7, 1, null, "No of Items", "2" },
                    { 8, 1, null, "Ocasion", "Casual" },
                    { 9, 1, null, "Package Contains", "2 tshirts" },
                    { 10, 1, null, "Patern", "Solid" },
                    { 11, 1, null, "Pattern Coverage", "Placement" },
                    { 12, 1, null, "Sleeve Length", "Short Sleeve" },
                    { 13, 1, null, "Sleeve Styling", "Regular Sleeve" },
                    { 14, 1, null, "Surface Stylying", "Applique" },
                    { 15, 1, null, "Sustainable", "Regular" },
                    { 16, 1, null, "Wash Care", "Machine Wash" },
                    { 17, 1, null, "Weave Type", "Knitted" }
                });
